...
PHONE</h1>
      ...
      <form ref={form} onSubmit={handleSubmit(onSubmit)} className='flex flex-col w-[80%] md:w-[40%] '>
        <div className='flex flex-col md:flex-row justify-between gap-x-10 py-8'>
          <div className='flex flex-col w-full'>
            ...
            <input
              ...
              className='border-b-2 mt-1 w-full px-3 py-3 bg-hero focus:border-b-green text-xl shadow-sm placeholder-slate-400 focus:outline-none  '
            />
        ...
        <textarea
          ...
          className='border-b-2 mt-1 w-full px-3 py-5  focus:border-red text-xl shadow-sm placeholder-slate-400   '
        />
    ...
    <div className='mx-auto my-5 border-2 border-tertiary-dark' style={{ width: '100%', height: '60vh', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
    <iframe 
